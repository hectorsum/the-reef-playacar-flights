    ...
    $.ajax({
        ...
        success: function( response ) {                                       
            if (response == -1){
                ...
                location.href= "/win/owa/ibe5_ext.check_itin?hotel=10453&lang=1&conf=" + response;
            }
        }
    });
    return false;
    ...
    $.ajax({
        ...
        success: function( response ) {                                       
            if (response == -1){
                ...
                location.href= "/win/owa/ibe5_ext.check_itin?hotel=10453&lang=1&conf=" + response + "&lastname=" + $("#lastname3").val();
            }
        }
    });
    return false;
    ...
    $.ajax({
        ...
        success: function( response ) {                                       
            if (response == -1){
                ...
                location.href= "/win/owa/ibe5_ext.check_itin?hotel=10453&lang=1&conf=" + response + "&lastname=" + $("#lastname2").val();
            }
        }
    });
    return false;
...
ageOption+='<option value="12">12</option>';
    ...
    function parse_rates(xml) {   
        ...
        $.ajax({
            type: "GET",            
            async: false,
            url: "/hotel_fastlink_js/10453.xml",
            dataType: "xml",
